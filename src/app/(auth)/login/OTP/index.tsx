...
import { formatTime } from '../../../../assets/utils/function';
import { Link } from 'react-router-dom';
import { primaryNew } from '../../../../theme/color';
import { URLS } from '../../../../constant/urls';
import { setActiveUI } from '../../../../redux/slices/auth.slice';
...
const ResendButton = styled(CustomButton)(({ theme }) => ({
    ...
    '&:disabled': {
        color: theme.palette.initial.alpha40
    }
}));
...
const OTP = () => {
    ...
    const renderButton = ({ onClick, ...buttonProps }) => (
        <RenderButtonBox>
            <Box mb={2}>
            ...
            <ResendButton {...{ onClick }} {...buttonProps} disabled={isResendDisabled}>
                Resend OTP
            </ResendButton>
        </RenderButtonBox>
    );
    ...
    return (
        <Container>
            <Typography variant="h5" fontWeight={500} fontSize={24} color="#5E5873" mb={2}>
                Email Verification
            </Typography>
            ...
            <Typography variant="body1" fontWeight={700} color="#292F79" fontSize={16} mb={2}>
