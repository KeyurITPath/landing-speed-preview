...
const RenderCard = ({ course, isBecomeAMemberWithVerified, handleStartFree, isLoggedIn }) => {
    const { title, id, redirectionUrl, instructor, rating, image, category, originalPrice, price } =
        course || {};
