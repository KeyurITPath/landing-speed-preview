...
const ExtendTrial = ({
    ...
    const { data } = useSelector(({ popup }: any) => popup?.monthlySubscription);
     ...
     const [onSuccess, loading] = useAsyncOperation(async () => {
        ...
        const payload = {
            ...
            trial_activation_method: TRIAL_ACTIVATION_METHODS.SALES_EXTEND_TRIAL_2_POPUP,
    ...
    return  <>
            <Image src={encodeURI(image)} style={{
                borderRadius: '0px',
                aspectRatio: '16/6'
            }} alt="coursesBanner" width={600} height={280} />
            <Stack
                sx={{
                    alignItems: 'center',
                    py: 1.5,
            ...
            >
                <Typography variant="h6" sx={{ textAlign: 'center', fontWeight: 400 }}>
                    <Box dangerouslySetInnerHTML={{ __html: header }} sx={{ fontWeight: 400 }} />
                </Typography>
            </Stack>
            <Stack
                sx={{
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Stack sx={{ bgcolor: '#FF3A44', py: 0.5, px: 1.5, borderRadius: 1.2 }}>
                            <Typography
                                variant="body2"
