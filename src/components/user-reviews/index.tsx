...
import { Box, Container, Rating, Stack, Typography, useMediaQuery } from '@mui/material';
...
const UserReviews = () => {
    ...
    return (
        <Box sx={{ width: '100%', backgroundColor: 'primary.background', py: { xs: 2, md: 6 } }}>
            <Container maxWidth="lg">
                ...
                >
                    ...
                    <Box sx={{ width: '100%', position: 'relative', top: { xs: '-40px', sm: 0 } }}>
                        <Swiper
                        ...
                        >
                            <Box sx={{ position: 'relative' }}>
                                {USER_REVIEWS?.map(({ name, rating, messageKey, image }, index) => {
                                    return (
